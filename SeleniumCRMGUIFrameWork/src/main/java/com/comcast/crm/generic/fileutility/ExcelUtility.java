...
/**
 * @author Pavan Kuamr rajbhar
 * File utility consists of reusable classes to extract the data from Excel 
 * 
 */
public class ExcelUtility {
	...
	public int getColoumncount(String sheetname) throws Throwable{
		FileInputStream fis=new FileInputStream("./testData/TestScriptData1.xlsx");
		Workbook wb=WorkbookFactory.create(fis);
		int coloumnCount=wb.getSheet(sheetname).getRow(0).getLastCellNum();
		return coloumnCount;
	}
